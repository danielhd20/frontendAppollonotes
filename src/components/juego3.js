...
class Prueba extends Component {
  ...
  Verificar(){
    ...
    else if(itms[0].content === ordenado[0].content &&
        itms[1].content === ordenado[1].content &&
        itms[2].content === ordenado[2].content &&      
        itms[3].content === ordenado[3].content &&
        itms[4].content === ordenado[4].content &&
        itms[5].content === ordenado[5].content &&
        itms[6].content === ordenado[6].content
      )
    {
      Swal.fire({
  ...
  render() {
    ...
    <h5>Organiza y arrastra hacia la primer fila los items para crear la disposición correcta de intervalos de una <b>escala mayor</b></h5> 
