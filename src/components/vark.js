                    ...
                    <div className='container'>  
                     <div className='row'>
                            <div className='col'>
                                ...
                                <iframe src="https://www.youtube.com/embed/XEhyq6KDPKE" title="Introducción" allowFullScreen></iframe>
                                </div>
                            </div>
                        </div>  
                ...
                <div className='Auditivo'>
                    <div className='container'>  
                     <div className='row'>
                            <div className='col'>
                                <div className="ratio ratio-16x9">
                                <iframe src="https://www.youtube.com/embed/BKkXjJ5sMlg" title="Intervalos" allowFullScreen></iframe>
                                </div>
                            </div>
                        </div>  
                          <button type="submit" className="btn text-light mt-2 fondobotonhome" onClick={() => handleSubmit2()}>Siguiente</button>
                ...
                <div className='Auditivo'>
                    <div className='container'>  
                     <div className='row'>
                            <div className='col'>
                                <div className="ratio ratio-16x9">
                                <iframe src="https://www.youtube.com/embed/IqgeSyvuMQw" title="Escalas" allowFullScreen></iframe>
                                </div>
                            </div>
                        </div>  
                          <button type="submit" className="btn text-light mt-2 fondobotonhome" onClick={() => handleSubmit2()}>Siguiente</button>
                ...
                <div className='Auditivo'>
                    <div className='container'>  
                     <div className='row'>
                            <div className='col'>
                                <div className="ratio ratio-16x9">
                                <iframe src="https://www.youtube.com/embed/HIZe2wGmjLM" title="Acordes" allowFullScreen></iframe>
                                </div>
                            </div>
                        </div>  
                          <button type="submit" className="btn text-light mt-2 fondobotonhome" onClick={() => handleSubmit2()}>Siguiente</button>
