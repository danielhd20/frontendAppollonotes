...
class Prueba extends Component {
  ...
  Verificar(){
    ...
    if(itms.length<7){
      Swal.fire({
        ...
        itms[3].id === ordenado[3].id &&
        itms[4].id === ordenado[4].id &&
        itms[5].id === ordenado[5].id &&
        itms[6].id === ordenado[6].id 
      )
    {
      Swal.fire({
  ...
  render() {
    ...
    <h5>Ordena las notas de manera ascendente arrastrandolas hacia la primer fila y moviendolas horizontalmente en la misma fila</h5> 
